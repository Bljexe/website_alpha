		...
		<nav>
			...
			<ul class="nav">
				...
				<div class="panel">
					...
					<a href="#LoginWnd" rel="modal:open" class="link" title="Conectar a uma conta"><div class="ico_lock"></div></a>
					<a href="/register" class="link" title="Registrar-se"><div class="ico_user-plus"></div></a>				
</div>
				<?php } ?>
...
<h1><div class="ico_lock"></div> Conectar-se</h1>
<ul id="breadcrump">
        <li>Inicia sessão em sua conta <strong>Dofus <?php echo $name; ?></strong> !</li>
</ul>
  <div id="middle">
        <form method="post">
