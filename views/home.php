...
<div id="content">
    <h1>Olá, seja bem-vindo a <?php echo $name; ?>!</h1>
    <ul id="breadcrump">
    ...
    <div id="news">
        ...
        ?>
            <article>
                ...
                <div class="footer">
                    Publicado <strong><?php echo '' . $date . '' ?></strong> por <strong><?php echo $author ?></strong>.
                    <a href="/article/<?php echo $id + 1 ?>"><img src="/template/img/i_bulle.png" /> Ver mais</a>
                </div>
            </article>
        <?php
        }
...
?>
    <div id="content" style="min-height: 0px!important;">
        <div id="middle">
            <h2 align="center">
                <?php
                if ($hasPrevious && $hasNext)
