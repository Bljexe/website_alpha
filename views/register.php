...
<title>Dofus <?php echo $name; ?> | Registrar</title>
<div id="content">
    ...
    <div id="middle">
        <h2>Comece a jogar Dofus <?php echo $name; ?> !</h2>
        <p>
        <strong>Para começar a jogar no Dofus Alpha, o primeiro passo é se cadastrar, e este é o lugar.</strong></br>
        ...
        <form method="post">
            ...
            <button style="padding: 15px 90px!important;" name="register_validation" type="sumbit">Registrar-se</button>
        </form>
    </div>
</div>
